...
echo nl2br ('<center><h3 style="display: inline">Build around:</h3><p>' . $buildaroundmon . "</font></center>");
...
$row4b = [bussynomics($allmuhvars[9], $typelistns), bussynomics($allmuhvars[10], $typelistns), bussynomics($allmuhvars[11], $typelistns)];
$row5b = [bussynomics($allmuhvars[12], $typelistns), bussynomics($allmuhvars[13], $typelistns), bussynomics($allmuhvars[14], $typelistns)];
...
<br /><br />
<button class="large-button"><a href="http://xelly.ezyro.com/ffa3/gsh.php" style="color: inherit; text-decoration: inherit;">New Team</a></button>
...
<script>
    ...
    function copyText() {
    const text = "/challenge gen9freeforall@@@!Sleep Moves Clause,Sleep Clause Mod,+Uber, +ND Uber, !Obtainable, +Annihilape, +Arceus, +Calyrex-Ice, +Calyrex-Shadow, +Chi-Yu, +Darkrai, +Dialga, +Dialga-Origin, +Eternatus, +Flutter Mane, +Ho-Oh, +Giratina, +Giratina-Origin, +Groudon, +Hoopa-Unbound, +Iron Bundle, +Koraidon, +Kyogre, +Landorus-Base, +Lugia, +Magearna, +Mewtwo, +Miraidon, +Palafin, +Palkia, +Palkia-Origin, +Rayquaza, +Spectrier, +Shaymin-Sky, +Chien Pao,  +Ogerpon-Hearthflame, +Ursaluna, +Urshifu-Base, +Zacian, +Zacian-Crowned, +Moody, +Shadow Tag, +Toxic Debris, +Acupressure, +Aromatic Mist, +Baton Pass, +Court Change, +Final Gambit, +Flatter, +Follow Me, +Heal Pulse, +Last Respects, +Poison Fang, +Rage Powder, +Coaching, +Spicy Extract, +Swagger, +Toxic, +Toxic Spikes,+Toxic Chain,+Double Team,+Ursaluna-Bloodmoon,+Terapagos,!Species Clause";
